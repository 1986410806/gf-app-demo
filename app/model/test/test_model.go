...
// arModel is a active record design model for table test operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of test.
	Table = "test"
	// Model is the model object of test.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table test.
	Columns = struct {
		Id   string //
		Name string //
		Sex  string //
